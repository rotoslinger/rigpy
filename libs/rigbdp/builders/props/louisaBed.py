...
for mod in MODULES:
    reload(mod)
class LouisaBed(prop.PropBuild):
    def __init__(self,
                 name='louisaBed',
                 version=1,
                 props_path=r'C:\Users\harri\Documents\BDP\props',
                 model_file='louisaBed_base_model_h_v003.mb',
                 rig_geo_files='',
                 output_path='',
                 radius='',
                 guide_vis=True,
    ...
    def build_it(self):
        bed = prop_base.simple_component(side = "",
